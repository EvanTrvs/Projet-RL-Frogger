"""
Script principal pour l'entraînement d'un agent sur Frogger Atari 2600.
...
from algorithms.trpo_final.trpo import trpo_final
...
def run(config_path: str, checkpoint_path: Optional[str] = None):
    ...
    elif config.algorithm == "trpo":
        trpo_final(environment, config, preprocessor, preprocessed_frame.shape)
    else:
